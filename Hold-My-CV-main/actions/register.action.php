...
if($_POST){
 ...
 $result=$db->query("SELECT COUNT(*) as user FROM details WHERE (email_id='$email_id' && password='$password')");
 ...
 if($result['user']){
    ...
    die();  
        ...
        try{
            ...
            $db->query("INSERT INTO details(full_name,email_id,password) VALUES('$full_name','$email_id','$password')");
